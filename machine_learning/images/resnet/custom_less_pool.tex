...
\begin{document}
	\sbox{\mybox}{
		\begin{tikzpicture}
			...
			\node[rectangle, draw=gray, fill=orange](a)[]{7 conv, 8};
			\node[rectangle](pool1)[below=\nodedist of a]{pool, /2};
			\node[rectangle, draw=gray, fill=orange](b)[below=\nodedist of pool1]{5 conv, 8};
			...
			\node[rectangle, draw=gray, fill=flieder](a)[below=\halfnodedist of skip1]{5 conv, 16, /2};
			\node[rectangle, draw=gray, fill=flieder](b)[below=\nodedist of a]{5 conv, 16};
			...
			\node[rectangle, draw=gray, fill=lightgreen](a)[below=\halfnodedist of skip1]{5 conv, 32, /2};
			...
			\node[rectangle, draw=gray, fill=pink](a)[below=\halfnodedist of skip1]{5 conv, 64, /2};
			...
			\node[rectangle, draw=gray, fill=lightblue](a)[below=\halfnodedist of skip1]{3 conv, 128, /2};
