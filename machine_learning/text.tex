...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=11cm]{machine_learning/images/mlp}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=10cm]{machine_learning/images/gradient_descent}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=11cm]{machine_learning/images/cnn/filter.png}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=10cm]{machine_learning/images/imagenet/kernels}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=17cm]{machine_learning/images/imagenet/Krizhevsky-2012.png}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=8cm]{machine_learning/images/EEA}}
...
%\begin{figure}
%	\centering
%	\makebox[\textwidth]{\includegraphics[width=13cm]{machine_learning/images/frisbee_attention}}
%	\caption{}
...
\begin{figure}
	...
	\begin{minipage}[t]{7cm}
		\centering
		\makebox[\textwidth]{\includegraphics[width=7cm]{machine_learning/images/transformer_architecture}}
		\captionof{figure}{The original Transformer architecture \cite{NIPS2017_3f5ee243}.}
		\label{fig:machine_learning:transformer}
	\end{minipage}%
	\begin{minipage}[t]{9cm}
		\centering
		\makebox[\textwidth]{\includegraphics[width=9cm]{machine_learning/images/transformer/positional_encoding}}
...
\end{equation}
with hidden dimension $d_\text{ff}$, and a Gaussian error linear unit (GELU) activation~\cite{hendrycks2023gaussianerrorlinearunits}.
Dropout \cite{hinton2012improvingneuralnetworkspreventing} is a regularization technique, which prevents networks from overfitting by randomly zeroing out elements of the given tensor. Dropout is not applied during inference.
