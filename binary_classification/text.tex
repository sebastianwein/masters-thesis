...
\begin{figure}
	...
	\caption{The custom ResNet architecture that is employed in this work (\emph{left}) and ResNet18~\cite{DBLP:journals/corr/HeZRS15} (\emph{right}). One convolutional block is denoted \enquote{kernel size} conv, \enquote{out channels}, /\enquote{stride}. Skip connections are drawn as arrows. These are dashed if the dimensions do not match.}
...
The classification token is a vector of the same dimension, consisting of learnable parameters. These are initialized randomly. Following \cite{DBLP:journals/corr/abs-2010-11929}, instead of fixed sinusoidal positional encodings, learned position embeddings are added to the input tokens. These are initialized randomly.
...
The model employs a dropout probability of \SI{10}{\percent}. (The author of this thesis notes that the classification head's final dropout layer is unusual and was added by mistake.) The total model size is \SI{1.7}{\mega\nothing} learnable parameters. Apart from the learned embeddings, this is again independent of the input size.
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=12cm]{binary_classification/plots/learning_curves/curves}}
...
\begin{figure}
	...
	\begin{minipage}[t]{7.5cm}
		\centering
		\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/plots/comparison/performance}}
	...
	\begin{minipage}[t]{7.5cm}
		\centering
		\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/images/comparison/vram_size}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=7cm]{binary_classification/plots/auroc}}
...
\begin{subfigure}{0.48\textwidth}
	\centering
	\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/plots/snr}}
	\caption{}
...
\begin{subfigure}{0.48\textwidth}
	\centering
	\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/plots/merger_time}}
	\caption{}
	\label{fig:binary:merger_time}
\end{subfigure}
\begin{subfigure}{0.48\textwidth}
	\centering
	\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/plots/mass}}
	\caption{}
...
\begin{subfigure}{0.48\textwidth}
	\centering
	\makebox[\textwidth]{\includegraphics[width=8cm]{binary_classification/plots/spins}}
	\caption{}
