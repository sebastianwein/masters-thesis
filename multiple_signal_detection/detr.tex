...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=16cm]{multiple_signal_detection/images/DETR_detail_seagulls}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=11cm]{multiple_signal_detection/images/transformer}}
...
See a schematic of the original architecture in Fig.~\ref{fig:detr:detr}. In a way, DETR is a natural extension of the ViT~\cite{dosovitskiy2021an} architecture to multiple classification tokens.
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=9cm]{multiple_signal_detection/plots/cnn_encoder_detr_far}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=12cm]{multiple_signal_detection/plots/cnn_encoder_detr_mergers}}
