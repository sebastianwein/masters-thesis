...
The whole simulation script is available at \cite{git_simulation}.

\section{Detector Noise}
\label{sec:data_simulation:noise}
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=13cm]{data_simulation/images/ET-0304B-22/18213_ET10km.png}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=15cm]{data_simulation/images/multivariate_normal/multivariate_normal.png}}
...
\begin{figure}
	...
	\begin{minipage}{\textwidth}
		\centering
		\makebox[\textwidth]{\includegraphics[width=10cm, trim=0 30cm 30cm 0, clip]{data_simulation/images/frames/frames_crop.png}}
	...
	\begin{minipage}{\textwidth}
		\centering
		\makebox[\textwidth]{\includegraphics[width=18cm]{data_simulation/images/parameters/Detector-frame-The-two-orthogonal-arms-of-the-interferometer-form-the-x-and-y-axes-in_high_res.png}}
...
\begin{figure}
	...
	\begin{minipage}{\textwidth}
		\centering
		\makebox[\textwidth]{\includegraphics[width=15cm]{data_simulation/images/waveforms/waveform.png}}
	...
	\begin{minipage}{\textwidth}
		\centering
		\makebox[\textwidth]{\includegraphics[width=15cm]{data_simulation/images/waveforms/projection.png}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=10cm]{data_simulation/images/poisson/poisson}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=15cm]{data_simulation/images/waveforms/injection.png}}
...
\begin{figure}
	\centering
	\makebox[\textwidth]{\includegraphics[width=15cm]{data_simulation/images/waveforms/sample.png}}
